...
description: Strict TDD workflow enforcing test-first development. Always use for new features, bug fixes, refactoring, and behavior changes—write a failing test before any production code. Exceptions only with explicit permission: throwaway prototypes, generated code, configuration files.
---
